...
# Data files
tf.app.flags.DEFINE_string("data_path", "./TAC40_data/", "Data directory")
tf.app.flags.DEFINE_string("embedding_file", "embedding/senna/embeddings.txt", 
                           "embedding file")
tf.app.flags.DEFINE_string("embedding_vocab", "embedding/senna/words_TAC40.lst", 
                           "embedding vocab file")
tf.app.flags.DEFINE_string("train_file", "train_TAC40.txt", "training file")
tf.app.flags.DEFINE_string("test_file", "test_TAC40.txt", "Test file")
...
tf.app.flags.DEFINE_integer("classnum", 40, "Number of relations")

# Optimization details
tf.app.flags.DEFINE_integer("batch_size", 100, "Batch size")
tf.app.flags.DEFINE_integer("num_epoches", 100, "Number of epoches")
tf.app.flags.DEFINE_float("keep_prob", 0.8, "Dropout keep prob.")
